...
class CrimesControllerTest < ActionController::TestCase
  ...
  test "should create crime" do
    assert_difference('Crime.count') do
      post :create, crime: { Description: @crime.Description, Locality: @crime.Locality, Type: @crime.Type }
    end
  ...
  test "should update crime" do
    patch :update, id: @crime, crime: { Description: @crime.Description, Locality: @crime.Locality, Type: @crime.Type }
    assert_redirected_to crime_path(assigns(:crime))
  end
